                            ...
                            <div className={cx('cover-banner')}>
                                ...
                                <div className={cx('novel-info')}>
                                    ...
                                    <p className={cx('novel-des')}>
                                        Growing up in poverty, Sunny never expected anything good from life. However,
                                        even he did not anticipate being chosen by the Nightmare Spell and becoming
                                        However, even he did not anticipate being chosen by the Nightmare Spell and
                                        becoming
                                    </p>
                                </div>
                            </div>
